...
//        vv.setPreferredSize(new Dimension(350,350)); 
    ...
    private void initSliderPanel() throws FileNotFoundException {
        ...
        slider = new JSlider();
        slider.setMinimum(0);
        slider.setMaximum(app.getRunDuration());
        ...
        slider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                app.displayEpoch((int)((JSlider)e.getSource()).getValue());
                epochLabel.setText("Epoch:" + ((JSlider)e.getSource()).getValue());
                pushMessagesLabel.setText("Push messages: " + app.getNumberOfPushMessages((int)((JSlider)e.getSource()).getValue()));
    ...
    private void updateGraph(int epoch) {
        removeEdges();
        List < Pair > list = app.printEpoch(epoch);
